...
<div>
    ...
    <form method="post">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           aria-describedby="lastNameHelp" value="${customer.last_name}">
        ...
        <div class="form-row">
            <div class="col">
                <div class="form-group">
                    <label for="dateOfBirth">Notatka</label>
                    <input type="date"
                           name="dateOfBirth" id="dateOfBirth" class="form-control" placeholder="Dobry pracownik"
                           aria-describedby="dateOfBirthHelp" value="${customer.date_of_birth}">
